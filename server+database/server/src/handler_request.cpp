...
//тут надо написать все таргеты и заинклюдить все файлы с нашими обработчиками
void handle_request(
    ...
    try {
        ...
        if (req.method() == http::verb::post) {
            ...
            if (req.target() == "/login") {
                // handle_login(body, res, db_handler);
                std::cout << "надо добавить сбда как обработку наших новых функций";
            } else if (req.target() == "/registration") {
                // handle_registration(body, res, db_handler);
                std::cout << "надо добавить сбда как обработку наших новых функций";
            } else {
