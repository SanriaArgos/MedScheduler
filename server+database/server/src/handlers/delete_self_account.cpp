...
void delete_self_account(
    ...
    std::string user_type;
    {
        ...
        PGresult *result = PQexecParams(
            ...
            "SELECT user_type FROM users WHERE id = $1::int", 1, nullptr,
    ...
    if (user_type == "patient") {
        ...
        if (doctor_id >= 0) {
            ...
            PGresult *doctor_records = PQexecParams(
                ...
                &doctor_param, nullptr, nullptr, 0
            );
            if (doctor_records) {
                PQclear(doctor_records);
            }
