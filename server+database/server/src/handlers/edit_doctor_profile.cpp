...
void edit_doctor_profile(
    ...
    // 1) Нужны user_id и current_password
    ...
    // 2) Проверим, что user_type = "doctor"
    {
    ...
    // 3) Проверка текущего пароля (аналогично patient)
    ...
    // 4) Собираем список полей для UPDATE
