...
export default function DashboardPage() {
    ...
    const JuniorAdminDashboard = () => (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/junior-admin/users" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-semibold text-main2 mb-2">Управление пациентами</h3>
                <p className="text-gray-600">Просмотр и управление пациентами</p>
            </Link>
